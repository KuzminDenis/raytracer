...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_exam_t, stringdata) + ofs \
...
const QMetaObject exam::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_exam.data,
      qt_meta_data_exam,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_exam.stringdata))
        return static_cast<void*>(const_cast< exam*>(this));
